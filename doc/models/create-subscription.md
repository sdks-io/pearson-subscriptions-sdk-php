...
|  --- | --- | --- | --- | --- | --- |
| `terms` | [`?Terms`](../../doc/models/terms.md) | Optional | Container for the terms and renewal settings of the subscription. | getTerms(): ?Terms | setTerms(?Terms terms): void |
| `subscribeToRatePlans` | [`?(SubscribeToRatePlan[])`](../../doc/models/subscribe-to-rate-plan.md) | Optional | - | getSubscribeToRatePlans(): ?array | setSubscribeToRatePlans(?array subscribeToRatePlans): void |
