...
| `createSubscription` | [`?CreateSubscription`](../../doc/models/create-subscription.md) | Optional | Information about an order action of type `CreateSubscription`. | getCreateSubscription(): ?CreateSubscription | setCreateSubscription(?CreateSubscription createSubscription): void |
