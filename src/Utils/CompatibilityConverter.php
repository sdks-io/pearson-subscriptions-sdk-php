...
namespace PearsonSubscriptionsAPILib\Utils;
...
use PearsonSubscriptionsAPILib\Http\HttpContext;
use PearsonSubscriptionsAPILib\Http\HttpRequest;
use PearsonSubscriptionsAPILib\Http\HttpResponse;
