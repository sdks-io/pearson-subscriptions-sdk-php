...
use PearsonSubscriptionsAPILib\Controllers\HealthController;
use PearsonSubscriptionsAPILib\Controllers\SubscriptionsController;
use PearsonSubscriptionsAPILib\Utils\CompatibilityConverter;
use Unirest\Configuration;
use Unirest\HttpClient;

class PearsonSubscriptionsAPIClient implements ConfigurationInterface
{
    private $health;
    ...
    /**
     * @see PearsonSubscriptionsAPIClientBuilder::init()
     * @see PearsonSubscriptionsAPIClientBuilder::build()
     *
     * @param array $config
     */
     ...
     *
     * @return PearsonSubscriptionsAPIClientBuilder PearsonSubscriptionsAPIClientBuilder instance
     */
    public function toBuilder(): PearsonSubscriptionsAPIClientBuilder
    {
        return PearsonSubscriptionsAPIClientBuilder::init()
     ...
     *
     * @see PearsonSubscriptionsAPIClientBuilder::getConfiguration()
     */
    ...
    /**
     * Returns Health Controller
     */
    public function getHealthController(): HealthController
    {
        if ($this->health == null) {
            $this->health = new HealthController($this->client);
        }
        return $this->health;
    }
